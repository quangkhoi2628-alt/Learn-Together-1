        ...
        return (
            <div className="animate__animated animate__fadeIn max-w-3xl mx-auto space-y-6">
                <Card>
                    ...
                    <div className="mt-4 p-4 bg-gray-50 rounded-lg border prose max-w-none">
                    ...
                    <Card className="animate__animated animate__fadeIn">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <div className="p-3 bg-gray-50 rounded-lg text-gray-700 prose max-w-none"><MarkdownRenderer content={feedback.feedback} /></div>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="p-3 bg-green-50 rounded-lg border border-green-200">
                                    <h4 className="font-semibold text-green-800 mb-1">👍 Điểm mạnh:</h4>
                                    <p className="text-green-700 prose max-w-none"><MarkdownRenderer content={feedback.strengths} /></p>
                                </div>
                                <div className="p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                                    <h4 className="font-semibold text-yellow-800 mb-1">🤔 Cần cải thiện:</h4>
                                    <ul className="list-disc list-inside text-yellow-700 prose max-w-none">
                                        {feedback.weaknesses.map((w, i) => <li key={i}><MarkdownRenderer content={w} /></li>)}
                                    </ul>
                                </div>
                            </div>
                            <div>
                                <h4 className="font-semibold text-gray-800 mb-2">💡 Gợi ý cải thiện:</h4>
                                 <div className="p-3 bg-blue-50 rounded-lg text-blue-700 prose max-w-none"><MarkdownRenderer content={feedback.suggestedImprovements} /></div>
                            </div>
                        </div>
                    </Card>
                )}
            ...
            <div className="animate__animated animate__fadeIn max-w-2xl mx-auto">
                <Card>
                    ...
                    <div className="mt-4 p-4 bg-gray-50 rounded-lg border">
                        <div className="text-lg font-semibold text-gray-800 prose max-w-none">
                           <MarkdownRenderer content={question.question} />
                        </div>
                    </div>
                    <textarea
        ...
        return (
            <div className="animate__animated animate__fadeIn max-w-3xl mx-auto space-y-6">
                 <Card>
                    ...
                    <div className="p-4 bg-gray-100 rounded-lg prose max-w-none"><MarkdownRenderer content={question.question}/></div>
                    ...
                    <>
                        <Card>
                            ...
                            <div className="space-y-4">
                                <div>
                                    <h4 className="font-semibold text-gray-800 mb-2">💬 Nhận xét chung:</h4>
                                    <div className="p-3 bg-gray-50 rounded-lg text-gray-700 prose max-w-none"><MarkdownRenderer content={currentFeedback.feedback}/></div>
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="p-3 bg-green-50 rounded-lg border border-green-200">
                                        <h4 className="font-semibold text-green-800 mb-1">👍 Điểm mạnh:</h4>
                                        <p className="text-green-700 prose max-w-none"><MarkdownRenderer content={currentFeedback.strengths}/></p>
                                    </div>
                                    <div className="p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                                        <h4 className="font-semibold text-yellow-800 mb-1">🤔 Cần cải thiện:</h4>
                                        <ul className="list-disc list-inside text-yellow-700 prose max-w-none">
                                            {currentFeedback.weaknesses.map((w, i) => <li key={i}><MarkdownRenderer content={w}/></li>)}
                                        </ul>
                                    </div>
                                </div>
                                <div>
                                    <h4 className="font-semibold text-gray-800 mb-2">💡 Gợi ý cải thiện:</h4>
                                     <div className="p-3 bg-blue-50 rounded-lg text-blue-700 prose max-w-none"><MarkdownRenderer content={currentFeedback.suggestedImprovements} /></div>
                                </div>
                            </div>
                        </Card>
                                ...
                                <div className="space-y-4">
                                    {followUpExercises.map((ex, idx) => (
                                        <div key={idx} className="p-3 bg-purple-50 rounded-lg border border-purple-200">
                                            <div className="font-semibold text-purple-800 prose max-w-none"><MarkdownRenderer content={`${idx + 1}. ${ex.question}`} /></div>
                                            <div className="text-sm mt-2 space-y-1 text-purple-700">
                                                {ex.options.map(opt => <div key={opt} className="prose max-w-none"><MarkdownRenderer content={`- ${opt}`} /></div>)}
                                            </div>
                                            <p className="text-sm mt-2 font-bold text-purple-900 prose max-w-none">Đáp án đúng: <MarkdownRenderer content={ex.correctAnswer} /></p>
                                        </div>
                                    ))}
                                </div>
                            </Card>
        ...
        return (
            <div className="animate__animated animate__fadeIn">
                <Card>
                    ...
                    <div className="text-xl font-bold mb-6 prose max-w-none">
                        <MarkdownRenderer content={question.question} />
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
