...
import { MOCK_EXAMS_MATH_GRADE_9_FINAL_1, MOCK_EXAMS_MATH_GRADE_9_MIDTERM_1 } from './mockExamsMath';
...
export const MOCK_EXAMS: { [key in Grade]?: { [key in Subject]?: { [key in 'midterm1' | 'final1' | 'midterm2' | 'final2']?: AnyMockExam[] } } } = {
    9: {
        "Toán": {
            "midterm1": MOCK_EXAMS_MATH_GRADE_9_MIDTERM_1,
            "final1": MOCK_EXAMS_MATH_GRADE_9_FINAL_1
        },
        "Ngữ Văn": {
