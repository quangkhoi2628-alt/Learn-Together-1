...
import { HomeIcon, BookOpenIcon, CheckSquareIcon, SparklesIcon, LightbulbIcon, ClipboardIcon, CalculatorIcon, GlobeIcon, BeakerIcon, AtomIcon, LeafIcon, LockIcon, LogOutIcon, FileTextIcon, MenuIcon, XIcon, CameraIcon, UploadCloudIcon, LandmarkIcon, ScaleIcon, CalendarDaysIcon, Trash2Icon } from './components/Icons';
...
const Dashboard: React.FC<{
  ...
  onClearHistory: () => void;
}> = ({ setActiveView, practiceHistory, solutionHistory, aiToolHistory, onSelectProgressCategory, onClearHistory }) => {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <Card className="lg:col-span-1 flex flex-col">
                    <div className="flex justify-between items-center mb-4">
                        <h3 className="font-bold text-lg text-gray-800 flex-shrink-0">Lịch sử hoạt động</h3>
...
export default function App() {
  ...
  const handleClearHistory = () => {
    if (window.confirm("Bạn có chắc chắn muốn xóa toàn bộ lịch sử hoạt động không? Hành động này không thể hoàn tác.")) {
      setPracticeHistory([]);
      setSolutionHistory([]);
      setAIToolHistory([]);
    }
